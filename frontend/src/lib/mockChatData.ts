...
const conversation1Messages: Message[] = [
  ...
  },
  {
    id: generateId(),
    content:
      '¡Hola! Estaré encantado de ayudarte con matemáticas. ¿Qué tema específico necesitas repasar?',
    role: 'assistant',
  ...
  },
  {
    id: generateId(),
    content:
      'Perfecto. Las ecuaciones cuadráticas tienen la forma ax² + bx + c = 0. Te explico paso a paso cómo resolverlas usando la fórmula cuadrática...',
    role: 'assistant',
...
const conversation2Messages: Message[] = [
  ...
  },
  {
    id: generateId(),
    content:
      '¡Por supuesto! La fotosíntesis es el proceso por el cual las plantas convierten la luz solar en energía química. Te explico cómo funciona:',
    role: 'assistant',
  ...
  },
  {
    id: generateId(),
    content:
      "Excelente pregunta. La clorofila es el pigmento verde que captura la energía lumínica. Actúa como una 'antena molecular' que absorbe principalmente luz roja y azul...",
    role: 'assistant',
...
export const mockConversations: Conversation[] = [
  {
    ...
    lastMessage:
      'Perfecto. Las ecuaciones cuadráticas tienen la forma ax² + bx + c = 0...',
